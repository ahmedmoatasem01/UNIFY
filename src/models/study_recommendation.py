...
Represents AI-recommended study resources for a student
"""
...
class StudyRecommendation:
    ...
    def __repr__(self):
        return f"<StudyRecommendation(Recommendation_ID={self.Recommendation_ID}, Student_ID={self.Student_ID}, Resource_Type='{self.Resource_Type}')>"
